...
const operaciones = [sumarArrow, restarArrow, multiArrow, dividirArrow];
...
console.log(operar(60, 43, sumarArrow));
console.log(operar(60, 43, restarArrow));
console.log(operar(60, 43, multiArrow));
console.log(operar(60, 43, dividirArrow));
aplicarATodas(50,12, operaciones)
